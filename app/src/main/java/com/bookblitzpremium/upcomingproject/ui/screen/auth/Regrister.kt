...
@Composable
fun RegristerPage(showToggleToTablet: Boolean,  onNextButtonClicked: () -> Unit, navController: NavController, viewModel: UserLogin){
    ...
    val isNotMatching = rememberSaveable {
        derivedStateOf {
            password != confirmPassword
        }
    }

    val notMatching: Boolean = isNotMatching.value
