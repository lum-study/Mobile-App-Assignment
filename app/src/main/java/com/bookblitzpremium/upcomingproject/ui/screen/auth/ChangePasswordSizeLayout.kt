...
@Composable
fun DynamicChangePassword(onNextButtonClicked: () -> Unit, navController: NavController, userLoginViewModel: UserLogin) {
    ...
    ChangePassword(showTabletUI, onNextButtonClicked)
}
